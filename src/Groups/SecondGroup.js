...
function SecondGroup(props) {
  ...
  return (
    <div className="SecondGroup">
      <div className={value.toggleState === 2 ? "main__content main__content-active" : "main__content"}>
        ...
        <label className='main__content-label'>Сума для оподаткування:</label><input className='main__content-input' onKeyPress={value.validateInput} onChange={changeInputMain} ref={inputMain} value={inputMainState} type="text" name='second-group' /><label className='main__content-value'>гривень</label>
