    ...
    <div className="App">
      <header className="header">
        <div className='header__container'>
          ...
          <h2 className="header__info">Дані актуальні з 1 січня 2022 року по 1 січня 2023 року</h2>
          <input className="header__input-group" type="button" value="1 група ФОП" />
      ...
      <main className='main'>
        <div className='main__container'>
          ...
          <div className='main__content'>
            <h3 className='main__content-title'>Калькулятор податків для ФОПів які загальній системі оподаткуванню</h3>
